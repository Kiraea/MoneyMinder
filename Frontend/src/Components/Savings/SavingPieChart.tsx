...
export const SavingPieChart = () => {
    ...
    let objPieChart: any = {}
    if (savingsData){
        objPieChart = convertToCategoryXAmount(categoryData, savingsData, pieSelectMonth, pieSelectYear);
    }
    ...
    return (
        <div className="flex flex-col flex-1 gap-5">
            ...
            <PieChart title={"Savings Distribution"} labelNames={categories} dataValues={amount}></PieChart>
        </div>
